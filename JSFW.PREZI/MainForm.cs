...
namespace JSFW.PREZI
{
    ...
    public class JSFW_PREZI_CONST
    {
        ...
        public static string ProjectFilesDrawImageDirectoryName = ProjectRootDirectoryName + @"\DrawImages";

        /// <summary>
        /// 새그림 이미지 경로.
        /// </summary>
        public static readonly string ProjectNewImagesDirectoryName = ProjectRootDirectoryName + @"\Images\Temp";
        ...
        internal static void CheckProjectDirectory()
        {
            ...
            if (Directory.Exists(ProjectFilesDrawImageDirectoryName) == false)
                Directory.CreateDirectory(ProjectFilesDrawImageDirectoryName);
             
            if (Directory.Exists(ProjectNewImagesDirectoryName) == false)
                Directory.CreateDirectory(ProjectNewImagesDirectoryName);
        }
    }
