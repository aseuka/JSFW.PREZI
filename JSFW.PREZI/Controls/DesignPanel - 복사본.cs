...
{
    public class DesignPanel : Panel, IATContent
    {
        ...
        */
        ...
        protected override void OnPaintBackground(PaintEventArgs e)
        {
            ...
            // 배경색은 White 이고
            // 지우개 색은 Transparent 임.  
            e.Graphics.Clear(Color.Transparent);
            e.Graphics.Clear(Color.White);
            // 배경에 사용되는 이미지를 <-- 그려줌.
            //using (Image img = Bitmap.FromFile(@"C:\Users\aseuk\Pictures\IMG_1655.jpg"))
            if( BackgroundImage != null)
            {
        ...
        { 
            ...
            // 펜모드 ( SaveImage 에서처럼 구분하면 지우개모드일때 화면이 까매짐. )
        ...
        internal void ChangePen(float penSize, Color penColor)
        {
            ...
            {
                // 지우개 펜
                CurrentPen = new Pen(Color.FromArgb(255, Color.Transparent ), penSize)
                {
                    StartCap = System.Drawing.Drawing2D.LineCap.Round,
                    EndCap = System.Drawing.Drawing2D.LineCap.Round,
                    DashStyle = System.Drawing.Drawing2D.DashStyle.Solid,
